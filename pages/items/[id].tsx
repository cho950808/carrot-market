      ...
      <div className="mb-8">
        ...
        <div className="mt-5">
          ...
          <div className="flex items-center justify-between space-x-2">
            <button className="flex-1 bg-orange-500 text-white py-3 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 hover:bg-orange-600 font-medium focus:ring-orange-500">
              Talk to seller
            </button>
